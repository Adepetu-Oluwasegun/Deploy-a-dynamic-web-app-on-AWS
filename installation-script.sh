...
S3_BUCKET_NAME=swy-project-web-files
...
# This command will open th vi editor and allow you to edit the .env file to add your database credentials (db_username, db_password, db_database and app_url) 
sudo nano .env
